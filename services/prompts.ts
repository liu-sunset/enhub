export const PROMPT_PREFIX = "You are an expert OCR and HTML formatter. Your task is to extract English text from the provided images and format it into a clean, readable HTML document.";
...
3. **Styling**:
   ...
   - **Background**: The body background must be a soothing light green (#f0fdf4). Ensure body has min-height: 100vh.
...
export const SYSTEM_PROMPT = `${PROMPT_PREFIX}\n${DEFAULT_INSTRUCTIONS}`;
